...
public class ProfilePanel extends CustomPanel{
    ...
    public ProfilePanel(ChatPanel chatPanel, Color color) {
        ...
        toggleButton.setBorder(App.emptyBorder);
        ...
        //toggleButton.setMaximumSize(new Dimension(Integer.MAX_VALUE, 20));
    ...
    private void openContactDialog() {
        ...
        CustomLabel addressLabel = new CustomLabel("Adress:", 0, Utilities.BODY, Font.PLAIN);
